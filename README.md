...
This repository provides the official pipelines for processing jGCaMP8f light-field videos using the LISTA-based net ("2PiLnet", or just "LNet) described in this [paper](https://www.biorxiv.org/content/10.1101/2025.03.17.643718v1).
